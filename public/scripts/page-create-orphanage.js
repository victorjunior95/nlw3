// create map
const map = L.map('mapid').setView([-15.8329381, -48.0699353], 15);
...
let marker; // inicia a variável vazia
...
function addPhotoField() {
  ...
  // verificar se o campo está vazio, se sim, não add ao conatiner de imagens
